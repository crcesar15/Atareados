/*
* @name jQuery.bootcomplete MODIFICAR LINEA 82, query envia el valor a buscar
                    ...
                    success: function( json ) {
                      //console.log(json);
                        ...
                        $.each( json, function(i, j) {
                            j = JSON.parse(j);
                        //    console.log(j);
                            results += '<a href="#" class="list-group-item" data-id="'+j.id_materia+'" data-label="'+j.nombre_materia+'">'+j.nombre_materia+'</a>'
                        });
